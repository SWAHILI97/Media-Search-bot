...
from plugins.index import handle_user_status
...
def get_reply_makup(query,totol):
    buttons = [
        [
            InlineKeyboardButton('Bonyeza hapa: '+ str(totol), switch_inline_query_current_chat=query),
        ]
        ]
